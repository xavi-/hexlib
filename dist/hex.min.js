...
m){var i=b.create(b.evented,{defaults:{type:"hexagonal",tapthreshold:400},reorient:function(a,g){this.origin.x=+a;this.origin.y=+g;this.root.style.left=a+"px";this.root.style.top=g+"px";this.elem.style.backgroundPosition=a+"px "+g+"px"}});b.extend(b,{grid:function(a,g){function h(k){if(e.enabled){var q=k.inside(a),o=k.mousepos(a);k={x:o.x-e.origin.x,y:o.y-e.origin.y};if(p.panning){if(p.enabled&&q){q=k.x-p.x;k=k.y-p.y;j.style.left=q+"px";j.style.top=k+"px";a.style.backgroundPosition=q+"px "+k+"px";
e.trigger("panmove",o.x-p.x-2*e.origin.x,o.y-p.y-2*e.origin.y)}}else{o=e.events.tileover;var v=e.events.tileout,w=e.events.gridover,x=e.events.gridout;if(!(!o&&!v&&!w&&!x)){k=e.translate(k.x,k.y);if(!(q&&l.x===k.x&&l.y===k.y)){v&&l.x!==null&&l.y!==null&&e.queue("tileout",l.x,l.y);!q&&x&&l.x!==null&&l.y!==null&&e.queue("gridout",l.x,l.y);if(q){w&&l.x===null&&l.y===null&&e.queue("gridover",k.x,k.y);o&&e.queue("tileover",k.x,k.y);l.x=k.x;l.y=k.y}else{l.x=null;l.y=null}e.fire()}}}}}function d(k){if(e.enabled)if(k.inside(a)){var q=
